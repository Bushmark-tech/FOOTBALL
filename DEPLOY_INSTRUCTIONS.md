...
| Key | Value | Notes |
|-----|-------|-------|
| `DATABASE_URL` | `postgresql://football_pro_user:dECkrRNA8SJGJdb6MR3r6A1KKE6l87n8@dpg-d5chogv5r7bs73b1m410-a/football_pro` | **Required for persistent data**. If omitted, checks for SQLite fallback. |
